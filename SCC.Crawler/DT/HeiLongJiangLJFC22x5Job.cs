...
namespace SCC.Crawler.DT
{
    ...
    public class HeiLongJiangLJFC22x5Job : IJob
    {
        /// <summary>
        /// 初始化函数
        /// </summary>
        public HeiLongJiangLJFC22x5Job()
        {
            log = new LogHelper();
        ...
        private string GetKaijiangDetails(List<HtmlNode> nodes)
        {
            ...
            {
                Gdje = "",
                Trje = nodes[2].InnerText.Replace(",", "").Replace("元", "")
            };
            //TODO 
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.HeiLongJiangLJFC22x5;
