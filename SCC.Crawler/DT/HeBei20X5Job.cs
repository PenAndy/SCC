...
namespace SCC.Crawler.DT
{
    ...
    public class HeBei20X5Job : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        ...
        private string GetKaijiangDetails(List<HtmlNode> nodes)
        {
            ...
            var list = new List<Kaijiangitem>
            {
                ...
                {
                    Name = "一等奖",
                    Total = nodes[3].InnerText.Replace(",", ""),
                    TotalMoney = nodes[4].InnerText.Replace(",", "")
                },
                new Kaijiangitem
                {
                    Name = "二等奖",
                    Total = nodes[5].InnerText.Replace(",", ""),
                    TotalMoney = nodes[6].InnerText.Replace(",", "")
                },
                new Kaijiangitem
                {
                    Name = "三等奖",
                    Total = nodes[7].InnerText.Replace(",", ""),
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.HeBei20X5;
