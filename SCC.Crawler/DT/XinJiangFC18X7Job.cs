...
namespace SCC.Crawler.DT
{
    ...
    public class XinJiangFC18X7Job : IJob
    {
        /// <summary>
        /// 初始化函数
        /// </summary>
        public XinJiangFC18X7Job()
        {
            log = new LogHelper();
        ...
        private string GetKaijiangDetails(List<HtmlNode> nodes)
        {
            ...
            {
                Gdje = "",
                Trje = nodes[2].InnerText.Replace("元", "").Replace(",", "")
            };
            //TODO 
            ...
            var list = new List<Kaijiangitem>
            {
                new Kaijiangitem
                {
                    ...
                    TotalMoney = nodes[4].InnerText.Replace(",", "")
                },
                new Kaijiangitem
                {
                    Name = "二等奖",
                    Total = nodes[5].InnerText,
                    TotalMoney = nodes[6].InnerText.Replace(",", "")
                },
                new Kaijiangitem
                {
                    Name = "三等奖",
                    Total = nodes[7].InnerText,
                    TotalMoney = nodes[8].InnerText.Replace(",", "")
                }
            };
        ...
        private List<OpenCode7DTModel> GetOpenListFromBackUrl()
        {
            ...
            try
            {
                ...
                if (table == null) return result;
                var trs = table[3].ChildNodes.Where(node => node.Name == "tr").ToList();
                trs.RemoveAll(w => w.GetAttributeValue("class", "") == "BottomTR");
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.XinJiangFC18X7;
