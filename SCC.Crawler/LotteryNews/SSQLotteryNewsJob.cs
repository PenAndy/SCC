...
{
   public class SSQLotteryNewsJob : IJob
    {
        ...
        private List<string> GetMainUrl(SCCConfig config)
        {
            ...
            for (int i = 1; i <= pages; i++)
            {
                ...
                if (i == 1)
                {
                     res = "http://www.zhcw.com/xinwen/caizhongxinwen-ssq/";
                }
                else
                {
        ...
        /// 福彩3D技巧
        /// </summary>
        private LotteryNewsType lotterySkillType = LotteryNewsType.SSQNews;
