...
{
  public  class SSQZhongJiangNewsJob : IJob
    {

        /// <summary>
        /// 构造函数
        /// </summary>
        public SSQZhongJiangNewsJob()
        {
            log = new LogHelper();
        ...
        private List<string> GetMainUrl(SCCConfig config)
        {
            ...
            for (int i = 1; i <= pages; i++)
            {
                ...
                if (i == 1)
                {
                    res = "http://www.zhcw.com/xinwen/caimingushi/ssq/";
                }
                else
                {
        ...
        /// 福彩3D技巧
        /// </summary>
        private LotteryNewsType lotterySkillType = LotteryNewsType.SSQZhongJiangNews;
