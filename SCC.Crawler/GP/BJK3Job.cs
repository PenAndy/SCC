...
namespace SCC.Crawler.GP
{
    ...
    public class BJK3Job : IJob
    {
        ...
        /// <returns></returns>
        private List<BeiJingK3Enitity> GetDocByBackUrl(bool IsToday = true)
        {
            var list = new List<BeiJingK3Enitity>();
            try
            {
        ...
        /// <returns></returns>
        private List<BeiJingK3Enitity> GetDocByMainUrl(bool IsToday = true)
        {
            var list = new List<BeiJingK3Enitity>();
            try
            {
                ...
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.BeiJingK3),
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.BeiJingK3;
