...
namespace SCC.Crawler.GP
{
    ...
    public class JL11X5Job : IJob
    {
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<JL11X5Entity> GetDocByMainUrl(bool IsToday = true)
        {
            ...
            try
            {
                ...
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.JiLin11X5),
        ...
        /// <returns></returns>
        private bool SaveRecord(JL11X5Entity data)
        {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.JiLin11X5;
