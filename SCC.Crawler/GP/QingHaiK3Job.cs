...
namespace SCC.Crawler.GP
{
    ...
    public class QingHaiK3Job : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        ...
        /// <returns></returns>
        private List<QingHaiK3Enitity> GetDocByBackUrl(bool IsToday = true)
        {
            var list = new List<QingHaiK3Enitity>();
            try
            {
                ...
                foreach (XmlNode xmlnode in records)
                {
                    ...
                    var tmp = new QingHaiK3Enitity
                    {
                        QiHao = num.Substring(2),
                        KaiJiangHao = CommonHelper.TRHandleCode(opencode),
        ...
        /// <returns></returns>
        private List<QingHaiK3Enitity> GetDocByMainUrl(bool IsToday = true)
        {
            var list = new List<QingHaiK3Enitity>();
            try
            {
                ...
                var url = string.Format("{0}{1}", Config.MainUrl, day);
                var HtmlResource = NetHelper.GetUrlResponse(url);
        ...
        /// <returns></returns>
        private bool SaveRecord(QingHaiK3Enitity data)
        {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.QingHaiK3;
