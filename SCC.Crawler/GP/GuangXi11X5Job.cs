...
namespace SCC.Crawler.GP
{
    ...
    public class GuangXi11X5Job : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        public GuangXi11X5Job()
        {
            log = new LogHelper();
        ...
        private Dictionary<string, string> GetDocByMainUrl(bool IsToday = true)
        {
            ...
            try
            {
                ...
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.GuangXi11x5),
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.GuangXi11x5;
