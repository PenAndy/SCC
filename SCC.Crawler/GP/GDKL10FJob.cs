    ...
    public class GDKL10FJob : IJob
    {
        ...
        private Dictionary<string, string> GetDocByMainUrl(bool IsToday = true)
        {
            ...
            try
            {
                ...
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.GuangDongKL10F),
        ...
        private Dictionary<string, string> GetOpenListFromBackUrl(string requestUrl, bool IsToday = true)
        {
            ...
            try
            {
                ...
                for (var i = 0; i < trs.Count; i++) //第一行是表头
                {
                    ...
                    matchQiHao = tds[0].InnerText.Trim().Substring(2);
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.GuangDongKL10F;
