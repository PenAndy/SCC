...
namespace SCC.Crawler.GP
{
    ...
    public class XinJiangXLCJob : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        public XinJiangXLCJob()
        {
            log = new LogHelper();
            services = IOC.Resolve<IOpen7Code>();
        ...
        private void CheckingYesterdayTheLotteryData()
        {
            ...
            if (FailedQiHaoList.Count > 0)
            {
                ...
                //    // if (email.AddEmail(Config.Area +currentLottery, fQiHao, CommonHelper.GenerateYesterdayOpenTime(Config, fQiHao))) 目前没有配置邮件信息数据库
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<XinJiangXLCEntity> GetDocByMainUrl(bool IsToday = true)
        {
            var list = new List<XinJiangXLCEntity>();
            try
            {
                var time = DateTime.Now;
                var arg = new OpenCaiApiArg
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.XinJiangXLC),
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<XinJiangXLCEntity> GetDocByBackUrl(bool IsToday = true)
        ...
        ///     数据服务
        /// </summary>
        private readonly IOpen7Code services;

        /// <summary>
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.XinJiangXLC;
    ...
    ///     开奖号实体
    /// </summary>
    public class XinJiangXLCEntity
    {
