...
namespace SCC.Crawler.GP
{
    ...
    public class YunNanSSCJob : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        ...
        /// <returns></returns>
        private List<YunNanSSCEntity> GetDocByBackUrl(bool IsToday = true)
        {
            ...
            try
            {
                ...
                foreach (XmlNode xmlnode in records)
                {
                    ...
                    {
                        Id = int.Parse(num.Substring(0, num.Length - 3) + num.Substring(num.Length - 2)),
                        OpenCode = opencode,
        ...
        public bool SaveRecord(YunNanSSCEntity data)
        {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.YunNanSSC;
