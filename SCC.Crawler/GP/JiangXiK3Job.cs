...
namespace SCC.Crawler.GP
{
    ...
    public class JiangXiK3Job : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<JiangXiK3Entity> GetDocByMainUrl(bool IsToday = true)
        {
            var list = new List<JiangXiK3Entity>();
            try
            {
                var time = DateTime.Now;
                var arg = new OpenCaiApiArg
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.JiangXiK3),
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<JiangXiK3Entity> GetDocByBackUrl(bool IsToday = true)
        ...
        /// <returns></returns>
        private bool SaveRecord(JiangXiK3Entity data)
        {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.JiangXiK3;
