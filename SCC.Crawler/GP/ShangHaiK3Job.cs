...
namespace SCC.Crawler.GP
{
    ...
    ///     上海快3
    /// </summary>
    public class ShangHaiK3Job : IJob
    {
        public ShangHaiK3Job()
        {
            log = new LogHelper();
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<ShangHaiK3Entity> GetDocByMainUrl(bool IsToday = true)
        {
            var list = new List<ShangHaiK3Entity>();
            try
            {
                var time = DateTime.Now;
                var arg = new OpenCaiApiArg
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.ShangHaiK3),
        ...
        /// <returns></returns>
        private bool SaveRecord(ShangHaiK3Entity data)
        {
        ...
        #region   爬取爱彩乐网站数据
        private List<ShangHaiK3Entity> GetDocByBackUrl(bool IsToday = true)
        {
            var list = new List<ShangHaiK3Entity>();
            try
            {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.ShangHaiK3;
