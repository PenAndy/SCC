...
namespace SCC.Crawler.GP
{
    ...
    public class TianJin11X5Job : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        public TianJin11X5Job()
        {
            log = new LogHelper();
        ...
        private Dictionary<string, string> GetOpenListFromBackUrl(string url, bool IsToday = true)
        {
            ...
            try
            {
                ...
                foreach (XmlNode xmlnode in records)
                {
                    ...
                    matchQiHao = xmlnode.Attributes["expect"].Value.Trim().Replace("-", "");
        ...
        private Dictionary<string, string> GetDocByMainUrl(bool IsToday = true)
        {
            ...
            try
            {
                ...
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.TianJin11x5),
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.TianJin11x5;
