...
namespace SCC.Crawler.GP
{
    ...
    public class ShanXiTaiYuanYTDJJob : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        public ShanXiTaiYuanYTDJJob()
        {
            log = new LogHelper();
        ...
        /// <returns></returns>
        private List<ShanXiTaiYuanYTDJJobEnitity> GetDocByBackUrl(bool IsToday = true)
        {
            var list = new List<ShanXiTaiYuanYTDJJobEnitity>();
            try
            {
                ...
                foreach (XmlNode xmlnode in records)
                {
                    ...
                    var tmp = new ShanXiTaiYuanYTDJJobEnitity
                    {
                        QiHao = num,
        ...
        /// <returns></returns>
        private List<ShanXiTaiYuanYTDJJobEnitity> GetDocByMainUrl(bool IsToday = true)
        {
            var list = new List<ShanXiTaiYuanYTDJJobEnitity>();
            try
            {
                ...
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.ShanXiTaiYuan481),
        ...
        /// <returns></returns>
        private bool SaveRecord(ShanXiTaiYuanYTDJJobEnitity data)
        {
            ...
            if (services.AddOpen4Code(currentLottery, model))
            {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.ShanXiTaiYuan481;
    ...
    public class ShanXiTaiYuanYTDJJobEnitity
    {
