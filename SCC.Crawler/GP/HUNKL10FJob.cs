...
namespace SCC.Crawler.GP
{
    ...
    public class HUNKL10FJob : IJob
    {
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<HUNKL10FEntity> GetDocByMainUrl(bool IsToday = true)
        {
            var list = new List<HUNKL10FEntity>();
            try
            {
                var time = DateTime.Now;
                var arg = new OpenCaiApiArg
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.HuNanKL10F),
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<HUNKL10FEntity> GetDocByBackUrl(bool IsToday = true)

        {
            ...
            try
            {
                ...
                foreach (XmlNode xmlnode in records)
                {
                    ...
                    var num = xmlnode.Attributes["expect"].Value.Substring(2);
        ...
        /// <returns></returns>
        private bool SaveRecord(HUNKL10FEntity data)
        {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.HuNanKL10F;
