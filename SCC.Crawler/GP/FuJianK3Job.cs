...
namespace SCC.Crawler.GP
{
    ...
    public class FuJianK3Job : IJob
    {
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        private List<FuJianK3Entity> GetDocByMainUrl(bool IsToday = true)
        {
            var list = new List<FuJianK3Entity>();
            try
            {
                var time = DateTime.Now;
                var arg = new OpenCaiApiArg
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.FuJianK3),
        ...
        /// <returns></returns>
        private bool SaveRecord(FuJianK3Entity data)
        {
        ...
        /// <param name="IsToday"></param>
        /// <returns></returns>
        //private List<FuJianK3Entity> GetDocByBackUrl(Boolean IsToday = true)

        //{
        //    List<FuJianK3Entity> list = new List<FuJianK3Entity>();
        //    try
        //    {
        ...
        //                FuJianK3Entity tmp = new FuJianK3Entity()
        //                {
        //                    Id = int.Parse(num),
        //                    OpenCode = opencode,
        ...
        #region   爬取爱彩乐网站数据
        private List<FuJianK3Entity> GetDocByBackUrl(bool IsToday = true)
        {
            var list = new List<FuJianK3Entity>();
            try
            {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.FuJianK3;
