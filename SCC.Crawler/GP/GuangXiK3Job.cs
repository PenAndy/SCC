...
namespace SCC.Crawler.GP
{
    ...
    public class GuangXiK3Job : IJob
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        ...
        /// <returns></returns>
        private bool SaveRecord(GuangXiK3Entity data)
        {
        ...
        private List<GuangXiK3Entity> GetDocByBackUrl(bool IsToday = true)
        {
            var list = new List<GuangXiK3Entity>();
            try
            {
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.GuangXiK3;
