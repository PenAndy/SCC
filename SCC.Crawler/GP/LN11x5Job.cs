    ...
    public class LN11x5Job : IJob
    {
        ...
        private Dictionary<string, string> GetDocByMainUrl(bool IsToday = true)
        {
            ...
            try
            {
                ...
                {
                    code = EnumHelper.GetLotteryCode(SCCLottery.LiaoNing11X5),
        ...
        {
            var requestUrl = string.Format(Config.BackUrl);
        ...
        {
            var requestUrl =
                "http://map3.zhcw.com:88/jx11x5/liaoNing/11x5/11x5Jsp/ln11x5KJnumFengBuTuAsc.jsp?choose=yesterdayDate";
        ...
        private Dictionary<string, string> GetOpenListFromBackUrl(string url, bool IsToday = true)
        {
            ...
            try
            {
                ...
                var table = doc.GetElementbyId("table_jx11x5");
                ...
                for (var i = 0; i < trs.Count; i++) //第一行为表头
                {
                    ...
                    if (tds[0].InnerText.Contains("预选行")) break;
        ...
        ///     当前彩种
        /// </summary>
        private SCCLottery currentLottery => SCCLottery.LiaoNing11X5;
