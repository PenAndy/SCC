...
{
   public class SSQGlossaryJob : IJob
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public SSQGlossaryJob()
        {
            log = new LogHelper();
        ...
        private List<LotteryGlossaryModel> GetOpenListFromMainUrl(string mainUrl)
        {
            ...
            try
            {
                ...
                //获取li下面所有a标签
                HtmlNodeCollection nodeList = doc.DocumentNode.SelectNodes("//*[@id='ssq']/div[3]/ul/li/a");//*[@id="ssq"]/div[3]
        ...
        /// 福彩3D技巧
        /// </summary>
        private LotteryGlossaryType lotterySkillType = LotteryGlossaryType.SSQ;
