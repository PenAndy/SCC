...
namespace SCC.Common
{
    ...
    public sealed class SqlHelper
    {
        ...
        {
            return ConfigurationManager.ConnectionStrings["SCCConnectionString"].ConnectionString;
        }
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        {
            return ExecuteDataset(GetConnSting(), commandType, commandText, (SqlParameter[])null);
        }
        /// <summary>
        /// 执行指定类型的命令并返回DataSet
        /// </summary>
        ...
        /// <returns></returns>
        public static DataSet ExecuteDataset(CommandType commandType, string commandText, SqlParameter[] param)
        {
            return ExecuteDataset(GetConnSting(), commandType, commandText, param);
        }
