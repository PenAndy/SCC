...
namespace SCC.Services
{
    ...
    /// 开奖10个球号的彩种数据服务
    /// </summary>
    public class Open10CodeServices : BaseServices, IOpen10Code
    {
        /// <summary>
        /// 获取最新一条记录
        /// </summary>
        ...
        public OpenCode10Model GetLastItem(SCCLottery lottery)
        {
            ...
            {
                var result = LoadData<OpenCode10Model>(ds.Tables[0].Rows[0]);
                return result;
            }
            return null;
        }
        ...
        /// <param name="lottery">彩种名称</param>
        /// <returns></returns>
        public List<OpenCode10Model> GetListIn(SCCLottery lottery,bool IsToday)
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                var data = LoadDataList<OpenCode10Model>(ds.Tables[0]);
                return data;
            }
            else
            {
